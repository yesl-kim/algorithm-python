...
case_num = 5
path="/Users/kimyeseul/dev/algorithm/algorithm-python/ignore/pythonalgorithm_formac/섹션 5/11. 최대힙"
...
def judge():
    ...
    for i in range(case_num):
        ...
        while True:
            n=int(input())
            if n==-1: break
            elif n==0: res.append(answer.max_heappop(heap))
            else: answer.max_heappush(heap, n)
